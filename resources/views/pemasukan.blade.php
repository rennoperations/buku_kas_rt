    ...
    <div class="content">
      ...
      <div class="section-card">
        <div class="section-header">
          <div>
            <div class="section-title">Riwayat Pemasukan Kas</div>
            <div class="section-sub">Daftar semua transaksi yang telah berhasil diverifikasi</div>
          </div>
          <button class="btn-action btn-lihat" style="padding: 8px 16px;">Bulan Ini ▼</button>
        </div>
        <table>
          <thead>
            <tr>
