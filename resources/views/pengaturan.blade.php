...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="nav-item active" href="{{ url('/bendahara/pengaturan') }}">
  ...
  <div class="main">
    ...
    <div class="content">
      <div class="section-card" style="padding: 24px;">
        <div class="section-title" style="margin-bottom: 24px;">Pengaturan Sistem Kas RT</div>
        
        <div style="display: flex; flex-direction: column; gap: 20px; max-width: 600px;">
          <div>
            <label style="font-size: 12px; font-weight: 600; text-transform: uppercase; color: var(--ink-mid); margin-bottom: 8px; display: block;">Nominal Iuran Bulanan</label>
            <input type="number" value="50000" style="width: 100%; border: 1.5px solid var(--border); border-radius: 10px; padding: 12px 14px; font-family: 'Geist', sans-serif; font-size: 14px; outline: none;">
          </div>
          
          <div>
            <label style="font-size: 12px; font-weight: 600; text-transform: uppercase; color: var(--ink-mid); margin-bottom: 8px; display: block;">Bank Penerima</label>
            <input type="text" value="BCA" style="width: 100%; border: 1.5px solid var(--border); border-radius: 10px; padding: 12px 14px; font-family: 'Geist', sans-serif; font-size: 14px; outline: none;">
          </div>

          <div>
            <label style="font-size: 12px; font-weight: 600; text-transform: uppercase; color: var(--ink-mid); margin-bottom: 8px; display: block;">Nomor Rekening</label>
            <input type="text" value="1234567890" style="width: 100%; border: 1.5px solid var(--border); border-radius: 10px; padding: 12px 14px; font-family: 'Geist', sans-serif; font-size: 14px; outline: none;">
          </div>

          <div>
            <label style="font-size: 12px; font-weight: 600; text-transform: uppercase; color: var(--ink-mid); margin-bottom: 8px; display: block;">Atas Nama</label>
            <input type="text" value="RT 05 Desa Airi" style="width: 100%; border: 1.5px solid var(--border); border-radius: 10px; padding: 12px 14px; font-family: 'Geist', sans-serif; font-size: 14px; outline: none;">
          </div>

          <button class="btn-action btn-setuju" style="padding: 14px; font-size: 14px; margin-top: 10px;">Simpan Perubahan</button>
        </div>
      </div>
    </div>
