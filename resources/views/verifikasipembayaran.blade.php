...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="nav-item active" href="{{ url('/bendahara/verifikasi-pembayaran') }}">
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <div class="alert-banner" id="alertBanner">
        ...
        <span><strong id="alertCount">3</strong> pembayaran baru menunggu verifikasi Anda.</span>
      </div>
      ...
      <div class="section-card">
        <div class="section-header">
          <div>
            <div class="section-title">Daftar Pembayaran Menunggu Verifikasi</div>
            <div class="section-sub">Klik "Lihat" untuk memeriksa bukti transfer sebelum menyetujui</div>
          </div>
          <div class="search-box">
            ...
            <input type="text" id="searchInput" placeholder="Cari nama warga…" oninput="filterTable()">
          </div>
        </div>
